...
CREATE TABLE modificaciones (
    id_usuario      VARCHAR(40)                 NOT NULL COMMENT 'Identificador del usuario',
    id_material     VARCHAR(40)                 NOT NULL COMMENT 'Identificador del material',
    fecha_accion    DATETIME                    NOT NULL COMMENT 'Fecha y hora de la modificación',
    ...
    PRIMARY KEY (id_usuario, id_material, fecha_accion),
...
CREATE INDEX idx_modificaciones_fecha ON modificaciones (fecha_accion) COMMENT 'Índice para búsquedas por la fecha en la tabla modificaciones';
